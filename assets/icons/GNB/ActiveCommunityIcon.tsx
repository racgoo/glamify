...
const ActiveCommunityIcon = (props: any) => {
  return (
    <Svg
      width={24}
      height={24}
    ...
    >
      ...
      />
      <Path
        d="M3 19.5C3 12.044 9.044 6 16.5 6h15C38.956 6 45 12.044 45 19.5v3C45 29.956 38.956 36 31.5 36h-15c-.847 0-1.674-.078-2.476-.226l-.775-.144L9 39.88v-6.127l-.6-.45A13.478 13.478 0 013 22.5v-3z"
        fill="#0E1011"
      />
    </Svg>
  )
